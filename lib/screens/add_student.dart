...
//function for creating a new student and adding it to the database
  void addNewStudent(String newId, String newName, String newClass,
      String newStatus, String newMarks, String base64Image) async{
    ...
    newStudent = StudentModel(
     ...
     //calling a function in mainscreen for to set its state as well as tha function inserts student
                          ...
                          builder: (context,studentState,child) {
                            return ElevatedButton(
                              onPressed: () async {
                               ...
                               await studentState.addStudent(newStudent!);
